...
public class face {
			...
			private static final String APPID = "5f04a858";
			// 接口密钥(webapi类型应用开通人脸比对服务后，控制台--我的应用---人脸比对---相应服务的apikey)
			private static final String API_KEY = "8f06d9d0954c8d55f76092affd92ac5d";
			// 图片地址 
			 ...
			 * OCR WebAPI 调用示例程序
			 * 
			 * @param FILE_PATH1,FILE_PATH2
			 * @throws IOException
			 * @throws JSONException 
			 */
			public static String getFace(String FILE_PATH1, String FILE_PATH2) throws IOException, JSONException {
				Map<String, String> header = buildHttpHeader();
			//图片1和图片二Base64编码之后需要urlencode
			//	byte[] imageByteArray1 = FileUtil.read(FILE_PATH1);
//				String imageBase641 = new String(FILE_PATH1);
//				byte[] imageByteArray2 = FileUtil.read(FILE_PATH2);
//				String imageBase642 = new String(imageByteArray2, "UTF-8");
				//String result = HttpUtil.doPost1(WEBWFV_URL, header, "first_image=" + URLEncoder.encode(FILE_PATH1, "UTF-8") + "&" + "second_image="+ URLEncoder.encode(FILE_PATH2, "UTF-8"));
				String result = HttpUtil.doPost1(WEBWFV_URL, header, "first_image=" + FILE_PATH1 + "&" + "second_image="+ FILE_PATH2);
